...
cursor.execute("DROP TABLE Places") result
= cursor.fetchall()
for row in result:
print(row)
...
('Ooty', 'Adventure', 'Coimbatore International Airport', 88, 0, 'None', 'Hill
Station, Tea Gardens', 'Natural Beauty'),
('Backwaters', 'Sightseeing', 'Cochin International Airport', 54, 0, 'None',
'Houseboats, Waterways', 'Natural Beauty'),
('Hampi', 'Sightseeing', 'Hubli Airport', 144, 40, 'None', 'Ancient Ruins,
Temples', 'Historical'),
...
('Munnar', 'Adventure', 'Cochin International Airport', 110, 0, 'None', 'Tea
Gardens, Trekking', 'Natural Beauty'),
...
('Kodaikanal', 'Adventure', 'Madurai International Airport', 120, 0, 'None', 'Hill
Station, Lake', 'Natural Beauty'),('Chikmagalur', 'Adventure', 'Mangalore International Airport', 151, 0, 'None',
...
('Bandipur National Park', 'Adventure', 'Kempegowda International
Airport', 220, 300, '12+', 'Wildlife Safari, Tigers', 'Wildlife'),
...
'Natural Beauty'),
('Wayanad', 'Adventure', 'Calicut International Airport', 90, 0, 'None', 'Trekking,
...
('Jog Falls', 'Sightseeing', 'Hubli Airport', 134, 10, 'None', 'Waterfalls,
...
('Chennai', 'Sightseeing', 'Chennai International Airport', 12, 0, 'None', 'City
Life, Beaches', 'Urban'),
('Belur and Halebidu', 'Sightseeing', 'Mangalore International Airport', 170, 20,
'None', 'Temples, Sculptures', 'Historical'),
('Coonoor', 'Adventure', 'Coimbatore International Airport', 70, 0, 'None', 'Tea
Gardens, Trekking', 'Natural Beauty'),
('Varkala', 'Sightseeing', 'Trivandrum International Airport', 44, 0, 'None',
'Beach, Temple', 'Beach'),
11
('Horsley Hills', 'Adventure', 'Bengaluru International Airport', 160, 0, 'None', 'Hill
Station, Trekking', 'Natural Beauty'),
...
('Yelagiri', 'Adventure', 'Bengaluru International Airport', 145, 0, 'None', 'Hill
Station, Adventure Sports', 'Natural Beauty'),
('Araku Valley', 'Adventure', 'Visakhapatnam Airport', 120, 10, 'None', 'Coffee
Plantations, Trekking', 'Natural Beauty'),
('Srirangapatna', 'Sightseeing', 'Mysore Airport', 14, 5, 'None', 'Temples, River',
'Historical'),
('Kalpetta', 'Adventure', 'Calicut International Airport', 90, 0, 'None', 'Trekking,
Waterfalls', 'Natural Beauty'),
...
('Bhadrachalam', 'Sightseeing', 'Rajahmundry Airport', 185, 10, 'None', 'Temple,
River', 'Religious')
]
cursor.executemany("""
...
""")
hotels_data = [
(1, 'Royal Orchid Metropole', 'Kempegowda International Airport', 120.00, 'Wi-
Fi, Pool, Restaurant', '1234567890', 4.5),
(2, 'Taj Madikeri Resort & Spa', 'Mangalore International Airport', 200.00, 'Wi- Fi,
Spa, Restaurant', '0987654321', 4.7),
(3, 'Radisson Blu Resort', 'Chennai International Airport', 150.00, 'Beachfront, Pool,
Gym', '1122334455', 4.6),
(4, 'Dolphin Hotels', 'Rajiv Gandhi International Airport', 100.00, 'Wi-Fi, Parking,
Gym', '5566778899', 4.3),
(5, 'The Gateway Hotel Pasumalai', 'Madurai International Airport', 80.00, 'Pool,
Restaurant, Wi-Fi', '6677889900', 4.4),
(6, 'Savoy Hotel', 'Coimbatore International Airport', 90.00, 'Tea Gardens,
Restaurant, Wi-Fi', '7788990011', 4.2),
(7, 'Coconut Lagoon', 'Cochin International Airport', 175.00, 'Houseboats, Wi- Fi,
Spa', '8899001122', 4.8),
(8, 'Evolve Back', 'Hubli Airport', 250.00, 'Spa, Restaurant, Wi-Fi',
'9900112233', 4.9),
(9, 'Sparsa Resort', 'Trivandrum International Airport', 110.00, 'Sunrise View, Pool,
Restaurant', '1122445566', 4.5),
(10, 'Lake Palace Resort', 'Cochin International Airport', 180.00, 'Houseboats, Wi-
Fi, Spa', '2233445566', 4.7),
(11, 'SpiceTree Munnar', 'Cochin International Airport', 190.00, 'Tea Gardens, Spa,
Wi-Fi', '3344556677', 4.6),(12, 'Daiwik Hotels', 'Madurai International Airport', 85.00, 'Temple View,
Restaurant, Wi-Fi', '4455667788', 4.3),
(13, 'Kabini River Lodge', 'Kempegowda International Airport', 95.00, 'Wildlife
Safari, Wi-Fi', '5566778899', 4.7),
(14, 'Radisson Blu Resort Temple Bay', 'Chennai International Airport', 140.00,
'Shore Temple View, Wi-Fi, Pool', '6677889900', 4.6),
(15, 'Varkala Marine Palace', 'Trivandrum International Airport', 60.00, 'Cliffside,
Wi-Fi, Restaurant', '7788990011', 4.4),
(16, 'Spice Village', 'Cochin International Airport', 200.00, 'Wildlife Safari, Wi-
Fi, Pool', '8899001122', 4.8),
(17, 'Kodai Resort Hotel', 'Madurai International Airport', 130.00, 'Hill Station, Wi-
Fi, Restaurant', '9900112233', 4.5),
(18, 'The Serai Chikmagalur', 'Mangalore International Airport', 210.00, 'Coffee
Plantations, Wi-Fi, Spa', '1122334455', 4.7),
(19, 'Le Pondy Resort', 'Chennai International Airport', 180.00, 'Beachfront, Wi-
Fi, Restaurant', '2233445566', 4.5),
(20, 'The Windflower Resort & Spa', 'Kempegowda International Airport', 120.00,
'Wildlife Safari, Wi-Fi, Restaurant', '3344556677', 4.4),
(21, 'Namaste Café', 'Goa International Airport', 65.00, 'Beachfront, Wi-Fi,
Restaurant', '4455667788', 4.3),
(22, 'Hogenakkal Resort', 'Kempegowda International Airport', 75.00, 'Waterfall
View, Wi-Fi, Restaurant', '5566778899', 4.2),
(23, 'Grand Palace Hotel & Spa', 'Salem Airport', 105.00, 'Hill Station, Wi-Fi,
Restaurant', '6677889900', 4.5),
(24, 'Vythiri Resort', 'Calicut International Airport', 180.00, 'Trekking, Wi-Fi, Spa',
'7788990011', 4.7),
(25, 'Mount Palazzo', 'Kempegowda International Airport', 90.00, 'Sunrise View,
Wi-Fi, Restaurant', '8899001122', 4.4),
(26, 'Vivanta by Taj Bekal', 'Mangalore International Airport', 160.00, 'Beachfront,
Wi-Fi, Restaurant', '9900112233', 4.6),
(27, 'Shivanasamudra Lodge', 'Kempegowda International Airport', 50.00, 'Waterfall
View, Restaurant', '1122334455', 4.1),
(28, 'Sharavathi Adventure Camp', 'Hubli Airport', 75.00, 'Waterfalls, Wi-Fi,
Restaurant', '2233445566', 4.3),
15
(29, 'Heritage Madurai', 'Madurai International Airport', 95.00, 'Temples, Wi- Fi,
Restaurant', '3344556677', 4.6),
(30, 'Hassan Ashok Hotel', 'Kempegowda International Airport', 85.00,
'Temples, Wi-Fi, Restaurant', '4455667788', 4.4),
(31, 'Taj Connemara', 'Chennai International Airport', 160.00, 'City Life, Wi-Fi,
Pool', '5566778899', 4.6),
(32, 'Hoysala Village Resort', 'Mangalore International Airport', 170.00, 'Temples,
Wi-Fi, Spa', '6677889900', 4.7),
(33, 'Kurumba Village Resort', 'Coimbatore International Airport', 120.00, 'Tea
Gardens, Wi-Fi, Restaurant', '7788990011', 4.6),
(34, 'The Gateway Hotel Varkala', 'Trivandrum International Airport', 90.00, 'Beach,
Wi-Fi, Restaurant', '8899001122', 4.5),
(35, 'Horsley Hills Haritha Resort', 'Bengaluru International Airport', 60.00, 'Hill
Station, Wi-Fi, Restaurant', '9900112233', 4.2),
(36, 'Sangam Hotel', 'Madurai International Airport', 80.00, 'Bridge View, Wi- Fi,
Restaurant', '1122334455', 4.3),
(37, 'Hilton Garden Inn', 'Trivandrum International Airport', 150.00, 'Temples, Wi-
Fi, Restaurant', '2233445566', 4.6),
(38, 'Kumarakom Lake Resort', 'Cochin International Airport', 250.00, 'Backwaters,
Wi-Fi, Pool', '3344556677', 4.8),
(39, 'The Raviz Ashtamudi', 'Trivandrum International Airport', 140.00, 'Backwaters,
Wi-Fi, Spa', '4455667788', 4.7),
(40, 'Silent Valley Rainforest Retreat', 'Coimbatore International Airport',
190.00, 'Wildlife, Wi-Fi, Spa', '5566778899', 4.8),
(41, 'Vellore Hotel Saravana', 'Chennai International Airport', 60.00, 'Fort View,
Wi-Fi, Restaurant', '6677889900', 4.2),
(42, 'Agumbe Rainforest Resort', 'Mangalore International Airport', 85.00,
'Rainforest, Wi-Fi, Trekking', '7788990011', 4.5),
(43, 'Yelagiri Hills Resort', 'Bengaluru International Airport', 100.00, 'Hill Station,
Wi-Fi, Restaurant', '8899001122', 4.3),
(44, 'Araku Valley Resort', 'Visakhapatnam Airport', 95.00, 'Trekking, Wi-Fi,
Restaurant', '9900112233', 4.6),
(45, 'Srirangapatna Lodge', 'Mysore Airport', 55.00, 'Temple View, Wi-Fi,
Restaurant', '1122334455', 4.2),(46, 'Green Gates Hotel', 'Calicut International Airport', 80.00, 'Waterfalls, Wi- Fi,
Restaurant', '2233445566', 4.4),
(47, 'Chettinad Mansion Heritage', 'Madurai International Airport', 120.00,
'Mansions, Wi-Fi, Restaurant', '3344556677', 4.5),
(48, 'Auroville Guesthouse', 'Chennai International Airport', 50.00, 'Meditation, Wi-
Fi, Restaurant', '4455667788', 4.1),
(49, 'Hotel Bhadrachalam', 'Rajahmundry Airport', 70.00, 'Temple View, Wi-Fi,
Restaurant', '5566778899', 4.2)
]
cursor.executemany("""
INSERT INTO hotels
...
cursor.execute("SELECT DISTINCT name FROM places") elif
user_choice == "type":
cursor.execute("SELECT DISTINCT type FROM places")
results = cursor.fetchall()
conn.close()
return [row[0] for row in results] def
...
BG_GRAY = "#2c2c2c" BG_COLOR
= "#003366" TEXT_COLOR =
"#c0c0c0"
FONT = "Helvetica 14" FONT_BOLD
= "Helvetica 13 bold"
# Send function
def send():
send = "You -> " + e.get()
...
types = fetch_places_by_type_or_place("type") txt.insert(END,
"\nBot -> Here are the types of attractions:")
19
for t in types:
txt.insert(END, f"\n\t- {t}")
elif user == "place":
places = fetch_places_by_type_or_place("place") txt.insert(END,
"\nBot -> Here are the places you can visit:") for p in places:
txt.insert(END, f"\n\t- {p}")
else:
place_details = fetch_place_details(user) if
place_details:
...
txt.insert(END, f"\nNearby Hotel: {details[7]}, Phone: {details[8]} ,
Rating: {details[9]}/5")
txt.insert(END, f"\n---")
else:
...
e.grid(row=1, column=0)send_button = Button(root, text="Send", font=FONT_BOLD,
